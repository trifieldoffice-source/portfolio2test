...
export default function FAQ() {
  ...
  return (
    <section className="w-full py-32 bg-slate-950 text-white overflow-hidden border-t border-white/10">
      <div className="container mx-auto px-6 md:px-12 max-w-4xl">
        <AnimationWrapper animation="fade-up">
          <div className="text-center mb-20">
            <h2 className="text-4xl font-serif text-white mb-6">FAQ</h2>
            <p className="text-accent tracking-[0.5em] uppercase text-[10px]">よくある質問</p>
          </div>
        </AnimationWrapper>
                ...
                >
                  ...
                  <div className="shrink-0 ml-4">
                    {isOpen ? (
                      ...
                      <Plus className="w-5 h-5 text-accent/40 group-hover:text-accent transition-colors" />
                    )}
                  </div>
                </button>
                <AnimatePresence>
