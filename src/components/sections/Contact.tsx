              ...
              <div className="space-y-2 relative">
                ...
                <div className="relative">
                  <select className="w-full bg-transparent border-b border-white/20 pb-2 text-white font-light outline-none focus:border-gold appearance-none cursor-pointer">
                    ...
                    <option value="light" className="bg-deep-blue">〜¥500,000</option>
                    <option value="standard" className="bg-deep-blue">¥500,000 〜 ¥1,000,000</option>
                    <option value="business" className="bg-deep-blue">¥1,000,000 〜 ¥3,000,000</option>
                    <option value="premium" className="bg-deep-blue">¥3,000,000 〜 (ASK)</option>
                  </select>
