  ...
  return (
    ...
    >
      ...
      <motion.div 
        ...
        style={{ y: yBackground }}
      >
        <span className="text-[40vw] font-serif font-bold text-white opacity-[0.02] tracking-tighter mix-blend-overlay">
          01
        </span>
      </motion.div>
      ...
      <div className="relative z-10 w-full max-w-4xl mx-auto flex flex-col items-center text-center space-y-20">
        <AnimationWrapper animation="fade-up">
          <div className="space-y-4">
            <h2 className="text-xs tracking-[0.5em] text-accent uppercase opacity-80">Philosophy</h2>
        ...
        <div className="space-y-12 text-white/70 font-light leading-relaxed max-w-2xl text-sm md:text-lg tracking-[0.15em] font-sans">
          ...
          <AnimationWrapper animation="fade-up" delay={0.6}>
            <p className="text-accent italic font-serif">
