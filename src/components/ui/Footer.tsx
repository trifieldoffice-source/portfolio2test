        ...
        <div className="flex flex-col lg:flex-row justify-between gap-16 lg:gap-32">
          ...
          <div className="lg:w-1/3 space-y-8">
            ...
            <div className="flex gap-6">
              {[Instagram, Twitter, Linkedin].map((Icon, i) => (
                <a key={i} href="#" className="text-white/40 hover:text-accent transition-colors duration-300">
          ...
          <div className="lg:w-2/3 grid grid-cols-2 md:grid-cols-4 gap-12">
            <div className="space-y-6">
              <h4 className="text-accent text-[10px] tracking-[0.4em] uppercase font-bold">Navigation</h4>
            ...
            <div className="space-y-6">
              <h4 className="text-accent text-[10px] tracking-[0.4em] uppercase font-bold">Office</h4>
            ...
            <div className="space-y-6 md:col-span-2 flex flex-col justify-between items-end">
              <button 
                onClick={scrollToTop}
                className="group flex flex-col items-center gap-4 text-white/40 hover:text-accent transition-colors duration-500"
              >
