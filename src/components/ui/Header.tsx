  ...
  return (
    ...
    >
      <div className="container mx-auto px-6 md:px-12 flex justify-between items-center">
        <Link 
          href="/" 
          className="text-xl font-serif text-white hover:text-accent transition-colors duration-300 tracking-wider z-[60]"
        >
          TRIFIELD
        </Link>
            ...
            return (
              ...
              >
                <span className={`text-[11px] tracking-[0.2em] transition-colors duration-300 ${
                  isActive ? "text-accent" : "text-light-gray group-hover:text-white"
                }`}>
                  {link.name}
                </span>
                <motion.div
        ...
        <div className="md:hidden flex items-center z-[60]">
          <button 
            ...
            className="text-light-gray hover:text-accent focus:outline-none p-2"
      ...
      <AnimatePresence>
        {isMobileMenuOpen && (
          ...
          >
            ...
            <div className="mt-20 text-[10px] text-accent/40 tracking-[0.5em] uppercase">
