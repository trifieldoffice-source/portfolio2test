  ...
  return (
    <main className="w-full min-h-screen bg-deep-blue flex items-center justify-center px-6 overflow-hidden relative">
      ...
      <div className="absolute inset-0 pointer-events-none">
        <div className="absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 w-[80vw] h-[80vw] bg-accent/5 blur-[120px] rounded-full" />
      </div>
      ...
      <div className="relative z-10 text-center space-y-12 max-w-lg">
        ...
        >
          <span className="text-accent font-serif text-8xl md:text-9xl opacity-20 block mb-4 tracking-tighter">404</span>
        ...
        >
          <Link 
            href="/"
            className="flex items-center gap-3 bg-accent px-10 py-4 text-deep-blue text-xs tracking-[0.3em] uppercase font-bold hover:shadow-[0_0_30px_rgba(0,209,255,0.3)] transition-all duration-500"
          >
